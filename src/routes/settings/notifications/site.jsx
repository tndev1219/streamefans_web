                ...
                <Grid container direction="row">
                    ...
                    <Grid item xs={8} sm={8} md={8} lg={8} xl={8} style={{ borderRight: '1px solid #eee' }}>
                        <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 50, height: 48, paddingRight: 15, paddingLeft: 15 }}>
                            <span style={{ fontWeight: 500, fontSize: 19 }}>SITE NOTIFICATIONS</span>
                        </Box>
                        <Divider />
                        ...
                        >
                            <span style={{ fontSize: 12, color: 'rgba(138,150,163,.75)' }}>Get site notifications to find out what’s going on when you’re not on OnlyFans. You can turn them off anytime.</span>
                        </Box>
                        <Divider></Divider>
                    </Grid>
                </Grid>
...
export default React.memo(SitePage);